...
text(scale(1,tmpu1),mid_pos,[' Error: ' num2str(val_heret)  '  deg.'],'FontSize',ma_font_size)
    ...
    plot3(where_projy+0*scale,imag(spectrum),real(spectrum),'k-','LineWidth',thick_line_widht); hold on
    plot3(scale,1+0*imag(spectrum),real(spectrum),'k-'); hold on
    plot3(scale,imag(spectrum),real(spectrum),'k-','LineWidth',thick_line_widht); hold on
    ...
    plot3([sw/2 sw/2],[0 0 ],[0 1 ],'k','LineWidth',thick_line_widht);
